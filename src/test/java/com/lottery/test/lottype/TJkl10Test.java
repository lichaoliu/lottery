...
public class TJkl10Test {

	TJkl10 happy = new TJkl10();
	...
	public void testValidateS() {
		//选红
		Assert.assertEquals(true, happy.validate("100410-19^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100410-20^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100410-19^",new BigDecimal(400), new BigDecimal(2),200));
		Assert.assertEquals(true, happy.validate("100410-20^",new BigDecimal(20000), new BigDecimal(100),200));
		
		try {
			happy.validate("100410-18^",new BigDecimal(200), new BigDecimal(1),200);
		}catch(LotteryException e) {
			Assert.assertEquals(ErrorCode.betamount_error, e.getErrorCode());
		}
		
		//数投
		Assert.assertEquals(true, happy.validate("100411-12^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100411-12^13^",new BigDecimal(400), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100411-15^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100411-12^",new BigDecimal(400), new BigDecimal(2),200));
		Assert.assertEquals(true, happy.validate("100411-15^",new BigDecimal(20000), new BigDecimal(100),200));
		
		try {
			happy.validate("100411-19^",new BigDecimal(200), new BigDecimal(1),200);
		}catch(LotteryException e) {
			Assert.assertEquals(ErrorCode.betamount_error, e.getErrorCode());
		}
		...
		//任选二
		Assert.assertEquals(true, happy.validate("100412-01,02^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100412-01,03^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100412-01,02^",new BigDecimal(400), new BigDecimal(2),200));
		Assert.assertEquals(true, happy.validate("100412-01,03^",new BigDecimal(20000), new BigDecimal(100),200));
		
		try {
			happy.validate("100412-01,01^",new BigDecimal(200), new BigDecimal(1),200);
		}catch(LotteryException e) {
			Assert.assertEquals(ErrorCode.betamount_error, e.getErrorCode());
		}
		...
		//任选三
		Assert.assertEquals(true, happy.validate("100413-01,02,03^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100413-01,03,04^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100413-01,02,03^",new BigDecimal(400), new BigDecimal(2),200));
		Assert.assertEquals(true, happy.validate("100413-01,03,04^",new BigDecimal(20000), new BigDecimal(100),200));
		
		try {
			happy.validate("100413-01,01,02^",new BigDecimal(200), new BigDecimal(1),200);
		}catch(LotteryException e) {
			Assert.assertEquals(ErrorCode.betamount_error, e.getErrorCode());
		}
		
		//任选四
		Assert.assertEquals(true, happy.validate("100414-01,02,03,04^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100414-01,03,04,05^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100414-01,02,03,04^",new BigDecimal(400), new BigDecimal(2),200));
		Assert.assertEquals(true, happy.validate("100414-01,03,04,05^",new BigDecimal(20000), new BigDecimal(100),200));
		
		try {
			happy.validate("100414-01,01,02,04^",new BigDecimal(200), new BigDecimal(1),200);
		}catch(LotteryException e) {
			Assert.assertEquals(ErrorCode.betamount_error, e.getErrorCode());
		}
		...
		//任选五
		Assert.assertEquals(true, happy.validate("100415-01,02,03,04,05^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100415-01,03,04,05,06^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100415-01,02,03,04,05^",new BigDecimal(400), new BigDecimal(2),200));
		Assert.assertEquals(true, happy.validate("100415-01,03,04,05,06^",new BigDecimal(20000), new BigDecimal(100),200));
		
		try {
			happy.validate("100415-01,01,02,04,05^",new BigDecimal(200), new BigDecimal(1),200);
		}catch(LotteryException e) {
			Assert.assertEquals(ErrorCode.betamount_error, e.getErrorCode());
		}
		...
		//前二
		Assert.assertEquals(true, happy.validate("100416-01,02^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100416-01,03^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100416-01,02^",new BigDecimal(400), new BigDecimal(2),200));
		Assert.assertEquals(true, happy.validate("100416-01,03^",new BigDecimal(20000), new BigDecimal(100),200));
		
		try {
			happy.validate("100416-01,01^",new BigDecimal(200), new BigDecimal(1),200);
		}catch(LotteryException e) {
			Assert.assertEquals(ErrorCode.betamount_error, e.getErrorCode());
		}
		...
		//前三
		Assert.assertEquals(true, happy.validate("100417-01,02,03^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100417-01,03,04^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100417-01,02,03^",new BigDecimal(400), new BigDecimal(2),200));
		Assert.assertEquals(true, happy.validate("100417-01,03,04^",new BigDecimal(20000), new BigDecimal(100),200));
		
		try {
			happy.validate("100417-01,01,02^",new BigDecimal(200), new BigDecimal(1),200);
		}catch(LotteryException e) {
			Assert.assertEquals(ErrorCode.betamount_error, e.getErrorCode());
		}
		...
		//组二
		Assert.assertEquals(true, happy.validate("100418-01,02^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100418-01,03^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100418-01,02^",new BigDecimal(400), new BigDecimal(2),200));
		Assert.assertEquals(true, happy.validate("100418-01,03^",new BigDecimal(20000), new BigDecimal(100),200));
		
		try {
			happy.validate("100418-01,01^",new BigDecimal(200), new BigDecimal(1),200);
		}catch(LotteryException e) {
			Assert.assertEquals(ErrorCode.betamount_error, e.getErrorCode());
		}
		...
		//组三
		Assert.assertEquals(true, happy.validate("100419-01,02,03^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100419-01,03,04^",new BigDecimal(200), new BigDecimal(1),200));
		Assert.assertEquals(true, happy.validate("100419-01,02,03^",new BigDecimal(400), new BigDecimal(2),200));
		Assert.assertEquals(true, happy.validate("100419-01,03,04^",new BigDecimal(20000), new BigDecimal(100),200));
		
		try {
			happy.validate("100419-01,01,02^",new BigDecimal(200), new BigDecimal(1),200);
		}catch(LotteryException e) {
			Assert.assertEquals(ErrorCode.betamount_error, e.getErrorCode());
		}
...
//		Assert.assertEquals(true, happy.validate("100437-01#02,03,04^",new BigDecimal(360000), new BigDecimal(100),200));
	...
	public void testSplitS() {
		//选红
		happy.split("100410-19^", 200, 200*200, 200);
		happy.split("100410-19^19^", 200, 400*200, 200);
		
		//数投
		happy.split("100411-12^", 200, 200*200, 200);
		happy.split("100411-12^12^", 200, 400*200, 200);
		
		//任选二
		happy.split("100412-01,02^", 200, 200*200, 200);
		happy.split("100412-01,02^01,02^", 200, 400*200, 200);
		
		//任选三
		happy.split("100413-01,02,03^", 200, 200*200, 200);
		happy.split("100413-01,02,03^01,02,03^", 200, 400*200, 200);
		
		//任选四
		happy.split("100414-01,02,03,04^", 200, 200*200, 200);
		happy.split("100414-01,02,03,04^01,02,03,04^", 200, 400*200, 200);
		
		//任选五
		happy.split("100415-01,02,03,04,05^", 200, 200*200, 200);
		happy.split("100415-01,02,03,04,05^01,02,03,04,05^", 200, 400*200, 200);
		
		//前二
		happy.split("100416-01,02^", 200, 200*200, 200);
		happy.split("100416-01,02^01,02^", 200, 400*200, 200);
		
		//前三
		happy.split("100417-01,02,03^", 200, 200*200, 200);
		happy.split("100417-01,02,03^01,02,03^", 200, 400*200, 200);
		
		//组二
		happy.split("100418-01,02^", 200, 200*200, 200);
		happy.split("100418-01,02^01,02^", 200, 400*200, 200);
		
		//组三
		happy.split("100419-01,02,03^", 200, 200*200, 200);
		happy.split("100419-01,02,03^01,02,03^", 200, 400*200, 200);
	}
