...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara,String key) {
        ...
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	mysign = RSASignature.sign(prestr, key, AlipayConfig.input_charset);
        }
        return mysign;
    }
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(Map<String, String> sParaTemp,String key, String strMethod, String strButtonName, String strParaFileName) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp,key);
        List<String> keys = new ArrayList<String>(sPara.keySet());
