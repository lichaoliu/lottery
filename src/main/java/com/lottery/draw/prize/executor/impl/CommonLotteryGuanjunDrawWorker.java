...
@Service
public class CommonLotteryGuanjunDrawWorker extends AbstractLotteryDrawWorker{

	@Override
	public OrderCalResult draw(LotteryOrder order, String wincode)
			throws Exception {
		return guanjunService.calcuteJingcaiOrder(order.getId());
	}
