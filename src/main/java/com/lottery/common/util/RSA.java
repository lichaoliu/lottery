...
public class RSA {
	...
	public static Map<String, String> generateKeyPair() throws Exception {
		...
		String pub = new String(org.apache.commons.codec.binary.Base64.encodeBase64(publicKeyBytes),
				CharsetConstant.CHARSET_DEFAULT);
		/** 得到私钥 */
	...
	public static String encrypt(String source, String publicKey)
		...
		return new String(org.apache.commons.codec.binary.Base64.encodeBase64(b1),
				CharsetConstant.CHARSET_DEFAULT);
	}
	...
	public static String decrypt(String cryptograph, String privateKey)
		...
		byte[] b1 = org.apache.commons.codec.binary.Base64.decodeBase64(cryptograph.getBytes());
		/** 执行解密操作 */
	...
	public static PublicKey getPublicKey(String key) throws Exception {
		X509EncodedKeySpec keySpec = new X509EncodedKeySpec(
				org.apache.commons.codec.binary.Base64.decodeBase64(key.getBytes()));
	...
	public static String sign(String content, String privateKey) {
		String charset = CharsetConstant.CHARSET_DEFAULT;
		try {
