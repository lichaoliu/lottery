...
@Service
public class SJZConverter extends AbstractVenderConverter {
	...
	protected Map<LotteryType, String> getLotteryTypeMap() {
		...
		return SJZLotteryDef.lotteryTypeMap;
	}

	@Override
	public Map<Integer, String> getPlayTypeMap() {
		return SJZLotteryDef.playTypeMap;
	}
	...
	protected Map<LotteryType, IPhaseConverter> getPhaseConverterMap() {
		return SJZLotteryDef.phaseConverterMap;
	}
	...
	public String convertContent(Ticket ticket) {
		...
		if(SJZLotteryDef.playTypeToAdvanceConverterMap.containsKey(playType)){
			converter= SJZLotteryDef.playTypeToAdvanceConverterMap.get(playType);
		}
		if(converter!=null){
	...
	@Override
	protected void init() {
		venderConverterBinder.put(TerminalType.T_SJZ, this);
	}
