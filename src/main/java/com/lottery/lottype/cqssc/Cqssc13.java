...
public class Cqssc13 extends CqsscX{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		if(betcode.split(";")[0].contains(wins[2])
				&&betcode.split(";")[1].contains(wins[3])
				&&betcode.split(";")[2].contains(wins[4])) {
			return LotteryDrawPrizeAwarder.CQSSC_3D.value;
		}
