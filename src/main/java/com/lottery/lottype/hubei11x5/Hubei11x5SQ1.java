...
public class Hubei11x5SQ1 extends Hubei11x5X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String bet:betcodes) {
			if(wincode.substring(0, 2).equals(bet)) {
				prize.append(LotteryDrawPrizeAwarder.HUBEI11X5_Q1.value).append(",");
			}
		}
