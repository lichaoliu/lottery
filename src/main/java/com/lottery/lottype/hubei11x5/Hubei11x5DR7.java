...
public class Hubei11x5DR7 extends Hubei11x5X{

	@Override
	public String caculatePrizeLevel(String betcode, String wincode,
			int oneAmount) {
		return caculatePrizeDS(betcode, wincode, 5, LotteryDrawPrizeAwarder.HUBEI11X5_R7.value, 7);
	}

	@Override
	public long getSingleBetAmount(String betcode, BigDecimal beishu,
			int oneAmount) {
		if(!betcode.matches(DR7)) {
		...
		long zhushu = MathUtils.combine(tuo, 7-dan);
