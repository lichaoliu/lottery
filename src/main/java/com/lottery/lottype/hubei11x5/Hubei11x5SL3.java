...
public class Hubei11x5SL3 extends Hubei11x5X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String bet:betcodes) {
			if(wincode.substring(0, 8).equals(bet)) {
				prize.append(LotteryDrawPrizeAwarder.HB11X5_L31.value).append(",");
			}else if(3==totalHits(bet,wincode.substring(0, 8))) {
				prize.append(LotteryDrawPrizeAwarder.HB11X5_L32.value).append(",");
			}else if(3==totalHits(bet,wincode)) {
				prize.append(LotteryDrawPrizeAwarder.HB11X5_L33.value).append(",");
			}
		}
	...
	public long getSingleBetAmount(String betcode, BigDecimal beishu,
		...
		return betcode.split("\\^").length*200*3*beishu.longValue();
	}
