...
public class Hubei11x5SL5 extends Hubei11x5X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String bet:betcodes) {
			if(5==totalHits(bet,wincode)) {
				prize.append(LotteryDrawPrizeAwarder.HB11X5_L51.value).append(",");
			}else if(4==totalHits(bet,wincode)) {
				prize.append(LotteryDrawPrizeAwarder.HB11X5_L52.value).append(",");
			}
		}
