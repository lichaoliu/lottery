...
public class Hubei11x5MR4 extends Hubei11x5X{

	@Override
	public String caculatePrizeLevel(String betcode, String wincode,
			int oneAmount) {
		return caculatePrizeMS(betcode, wincode, 4, LotteryDrawPrizeAwarder.HUBEI11X5_R4.value,4);
	}

	@Override
	public long getSingleBetAmount(String betcode, BigDecimal beishu,
			int oneAmount) {
		if(!betcode.matches(MR4)) {
