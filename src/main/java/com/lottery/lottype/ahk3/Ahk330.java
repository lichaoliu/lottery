...
//三同号单式
//100830-01,01,01^02,02,02^
public class Ahk330 extends Ahk3X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String code:betcode.split("\\^")) {
			if(code.equals(wincode)) {
				prize.append(LotteryDrawPrizeAwarder.AHK3_ST_DAN.value).append(",");
			}
		}
		check2delete(prize);
...
//				slot.setBetcode("100830-"+sb.toString());
//				slot.setLotMulti(lotmulti);
//				slot.setAmt(getSingleBetAmount(slot.getBetcode(), new BigDecimal(lotmulti), 200));
//				list.add(slot);
