...
public class Gd11x5SL3 extends Gd11x5X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String bet:betcodes) {
			if(wincode.substring(0, 8).equals(bet)) {
				prize.append(LotteryDrawPrizeAwarder.GD11X5_L31.value).append(",");
			}else if(3==totalHits(bet,wincode.substring(0, 8))) {
				prize.append(LotteryDrawPrizeAwarder.GD11X5_L32.value).append(",");
			}else if(3==totalHits(bet,wincode)) {
				prize.append(LotteryDrawPrizeAwarder.GD11X5_L33.value).append(",");
			}
		}
