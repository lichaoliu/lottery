...
public class Gd11x5SL4 extends Gd11x5X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String bet:betcodes) {
			if(4==totalHits(bet,wincode)) {
				prize.append(LotteryDrawPrizeAwarder.GD11X5_L41.value).append(",");
			}else if(3==totalHits(bet,wincode)) {
				prize.append(LotteryDrawPrizeAwarder.GD11X5_L42.value).append(",");
			}
		}
