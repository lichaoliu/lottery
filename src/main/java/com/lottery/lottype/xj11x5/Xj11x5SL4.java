...
public class Xj11x5SL4 extends Xj11x5X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String bet:betcodes) {
			if(4==totalHits(bet,wincode)) {
				prize.append(LotteryDrawPrizeAwarder.XJ11X5_L41.value).append(",");
			}else if(3==totalHits(bet,wincode)) {
				prize.append(LotteryDrawPrizeAwarder.XJ11X5_L42.value).append(",");
			}
		}
