...
public class Gxkl10SHYTX3 extends Gxkl10X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String code:betcode.split("\\^")) {
			...
			if(total==3) {
				sb.append(LotteryDrawPrizeAwarder.GXKL10_HYTX3_3.value).append(",");
			}else if (total==2) {
				sb.append(LotteryDrawPrizeAwarder.GXKL10_HYTX3_2.value).append(",");
			}
		}
		if (sb.length() > 0) {
