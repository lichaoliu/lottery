...
public class Gxkl10SHYBX4b10 extends Gxkl10X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String code:betcode.split("\\^")) {
			...
			if(total==4) {
				sb.append(LotteryDrawPrizeAwarder.GXKL10_HY4BX10_4.value).append(",");
			}else if (total==5) {
				sb.append(LotteryDrawPrizeAwarder.GXKL10_HY4BX10_5.value).append(",");
			}
		}
		if (sb.length() > 0) {
