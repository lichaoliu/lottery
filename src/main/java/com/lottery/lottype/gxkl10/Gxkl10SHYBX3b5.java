...
public class Gxkl10SHYBX3b5 extends Gxkl10X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String code:betcode.split("\\^")) {
			...
			if(total==3) {
				sb.append(LotteryDrawPrizeAwarder.GXKL10_HY3BX5_3.value).append(",");
			}else if (total==4) {
				sb.append(LotteryDrawPrizeAwarder.GXKL10_HY3BX5_4.value).append(",");
			}else if (total==5) {
				sb.append(LotteryDrawPrizeAwarder.GXKL10_HY3BX5_5.value).append(",");
			}
		}
		if (sb.length() > 0) {
