...
public abstract class Jxk3X implements LotPlayType{
	...
	protected int lotterytype = LotteryType.JXK3.value;
	
	protected static String k310 = "(101510)[-](([1-6])([,]([1-6])){2}[\\^])+";
	
	protected static String k311 = "(101511)[-]([1-6])([,]([1-6])){0,5}[\\^]";
	
	protected static String k312 = "(101512)[-]([1-6])([,]([1-6])){0,4}[*]([1-6])([,]([1-6])){0,4}[\\^]";
	
	protected static String k320 = "(101520)[-](([1-6])[,]([1-6])[\\^])+";
	
	protected static String k321 = "(101521)[-]([1-6])([,]([1-6])){2,5}[\\^]";
	
	protected static String k322 = "(101522)[-]([1-6])[#]([1-6])([,]([1-6])){1,4}[\\^]";
	
	protected static String k330 = "(101530)[-](([1-6])([,]([1-6])){2}[\\^])+";
	
	protected static String k340 = "(101540)[-](([1-6])([,]([1-6])){2}[\\^])+";
	
	protected static String k341 = "(101541)[-]([1-6])([,]([1-6])){3,5}[\\^]";
	
	protected static String k342 = "(101542)[-]([1-6])([,]([1-6])){0,1}[#]([1-6])([,]([1-6])){1,4}[\\^]";
	
	protected static String k360 = "(101560)[-]([3-9]|1[0-8])([,]([3-9]|1[0-8])){0,15}[\\^]";//3和18转换成3同号单式
