...
public class Jxk322 extends Jxk3X{
	
	Jxk320 k20 = new Jxk320();
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		if(isErTong(wincode)) {
			...
			return LotteryDrawPrizeAwarder.JXK3_EBT_DAN.value;
			...
			if(total==0) {
				...
				return LotteryDrawPrizeAwarder.JXK3_EBT_DAN.value +","+LotteryDrawPrizeAwarder.JXK3_EBT_DAN.value;
			}
		}
		return LotteryDrawPrizeAwarder.NOT_WIN.value;
	}
	...
	private List<SplitedLot> transform(String betcode,int lotmulti) {
		...
		for(String code:tuo.split(",")) {
			...
			slot.setBetcode("101520-"+sortcode+"^");
