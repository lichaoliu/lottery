...
//二不同号胆拖
//100922-01#02,03,04,05,06^
public class Jsk322 extends Jsk3X{
	
	Jsk320 k20 = new Jsk320();
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		if(isErTong(wincode)) {
			...
			return LotteryDrawPrizeAwarder.JSK3_EBT_DAN.value;
			...
			if(total==0) {
				...
				return LotteryDrawPrizeAwarder.JSK3_EBT_DAN.value +","+LotteryDrawPrizeAwarder.JSK3_EBT_DAN.value;
			}
		}
		return LotteryDrawPrizeAwarder.NOT_WIN.value;
	}
	...
	private List<SplitedLot> transform(String betcode,int lotmulti) {
		...
		for(String code:tuo.split(",")) {
			...
			slot.setBetcode("100920-"+sortcode+"^");
...
//				slot.setBetcode("100920-"+sb.toString());
//				slot.setLotMulti(lotmulti);
//				slot.setAmt(k20.getSingleBetAmount(slot.getBetcode(), new BigDecimal(lotmulti), 200));
//				list.add(slot);
