...
//二不同号胆拖
//100522-01#02,03,04,05,06^
public class Gxk322 extends Gxk3X{
	
	Gxk320 k20 = new Gxk320();
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		if(isErTong(wincode)) {
			...
			return LotteryDrawPrizeAwarder.GXK3_EBT_DAN.value;
			...
			if(total==0) {
				...
				return LotteryDrawPrizeAwarder.GXK3_EBT_DAN.value+","
						+LotteryDrawPrizeAwarder.GXK3_EBT_DAN.value;
			}
		}
		return LotteryDrawPrizeAwarder.NOT_WIN.value;
	}
	...
	private List<SplitedLot> transform(String betcode,int lotmulti) {
		...
		for(String code:tuo.split(",")) {
			...
			slot.setBetcode("101020-"+sortcode+"^");
