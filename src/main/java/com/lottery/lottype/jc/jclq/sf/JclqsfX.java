...
public abstract class JclqsfX extends LotJingCaiPlayType{
	
	private static String sfregex = "[(][03]{1}([,][03]){0,1}[)]";
	private static String baseregex = RegexUtil.yyyymmdd+RegexUtil.matchlq+sfregex;
	...
	protected int getLotterytype() {
		return LotteryType.JCLQ_SF.value;
	}
