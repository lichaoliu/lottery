...
public abstract class JczqspfwrqX extends LotJingCaiPlayType{
	
	private static String spfwrqregex = "[(]([013]{1}([,][013]){0,2})[)]";
	private static String baseregex = RegexUtil.yyyymmdd+RegexUtil.matchzq+spfwrqregex;
	...
	protected int getLotterytype() {
		return LotteryType.JCZQ_SPF_WRQ.value;
	}
