...
public abstract class JczqbqcX extends LotJingCaiPlayType{
	
	private static String bqcregex = "[(](00|01|03|11|10|13|33|30|31){1}([,](00|01|03|11|10|13|33|30|31)){0,8}[)]";
	private static String baseregex = RegexUtil.yyyymmdd+RegexUtil.matchzq+bqcregex;
	...
	protected int getLotterytype() {
		return LotteryType.JCZQ_BQC.value;
	}
