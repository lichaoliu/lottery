...
public class Jx11x5SL3 extends Jx11x5X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for(String bet:betcodes) {
			if(wincode.substring(0, 8).equals(bet)) {
				prize.append(LotteryDrawPrizeAwarder.JX11X5_L31.value).append(",");
			}else if(3==totalHits(bet,wincode.substring(0, 8))) {
				prize.append(LotteryDrawPrizeAwarder.JX11X5_L32.value).append(",");
			}else if(3==totalHits(bet,wincode)) {
				prize.append(LotteryDrawPrizeAwarder.JX11X5_L33.value).append(",");
			}
		}
