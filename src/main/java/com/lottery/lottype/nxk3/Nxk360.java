...
//和值
//100560-04,05^
public class Nxk360 extends Nxk3X{
	...
	public String caculatePrizeLevel(String betcode, String wincode,
		...
		for (int code : codes) {
			if (code == num) {
				if (num == 4 || num == 17) {
					prize.append(LotteryDrawPrizeAwarder.NXK3_HZ_H2.value).append(",");
				} else if (num == 5 || num == 16) {
					prize.append(LotteryDrawPrizeAwarder.NXK3_HZ_H3.value).append(",");
				} else if (num == 6 || num == 15) {
					prize.append(LotteryDrawPrizeAwarder.NXK3_HZ_H4.value).append(",");
				} else if (num == 7 || num == 14) {
					prize.append(LotteryDrawPrizeAwarder.NXK3_HZ_H5.value).append(",");
				} else if (num == 8 || num == 13) {
					prize.append(LotteryDrawPrizeAwarder.NXK3_HZ_H7.value).append(",");
				} else if (num == 9 || num == 12) {
					prize.append(LotteryDrawPrizeAwarder.NXK3_HZ_H8.value).append(",");
				} else if (num == 10 || num == 11) {
					prize.append(LotteryDrawPrizeAwarder.NXK3_HZ_H9.value).append(",");
				}
			}
		}
		check2delete(prize);
